window.alert("Welcome to the evil number guessing game! To play please right click on the screen>inspect element>console and type game()");
...
function getPlayerGuess(){
    ...
    console.log("Please enter a valid number. Stupid.");
    }
}
